[![SemenkovVI](http://brest.rollingscopes.com/images/logo_rs_text.svg)](https://github.com/SemenkovVI/js-assignments.git)
#SemenkovVI
...
* Edit local README.md file and update all links (just replace all occurrences of `'SemenkovVI'` with your account name).
